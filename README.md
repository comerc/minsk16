...
## TODO заметки прямо в коде, как быстрый бэклог (не нужно описывать контекст)

Потребность выгружать вопросы из головы, на этом выстрелили Notion, Evernote, Obsidian.
